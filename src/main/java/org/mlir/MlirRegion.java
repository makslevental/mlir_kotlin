...
public class MlirRegion {
    ...
    public static MemoryLayout $LAYOUT() {
        return MlirRegion.$struct$LAYOUT;
    }
    ...
    public static VarHandle ptr$VH() {
        return MlirRegion.ptr$VH;
    }
    public static MemoryAddress ptr$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)MlirRegion.ptr$VH.get(seg);
    }
    public static void ptr$set( MemorySegment seg, MemoryAddress x) {
        MlirRegion.ptr$VH.set(seg, x);
    }
    public static MemoryAddress ptr$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)MlirRegion.ptr$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void ptr$set(MemorySegment seg, long index, MemoryAddress x) {
        MlirRegion.ptr$VH.set(seg.asSlice(index*sizeof()), x);
    }

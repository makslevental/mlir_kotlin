...
public class MlirDialectRegistry {

    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        Constants$root.C_POINTER$LAYOUT.withName("ptr")
    ).withName("MlirDialectRegistry");
    public static MemoryLayout $LAYOUT() {
        return MlirDialectRegistry.$struct$LAYOUT;
    }
    ...
    public static VarHandle ptr$VH() {
        return MlirDialectRegistry.ptr$VH;
    }
    public static MemoryAddress ptr$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)MlirDialectRegistry.ptr$VH.get(seg);
    }
    public static void ptr$set( MemorySegment seg, MemoryAddress x) {
        MlirDialectRegistry.ptr$VH.set(seg, x);
    }
    public static MemoryAddress ptr$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)MlirDialectRegistry.ptr$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void ptr$set(MemorySegment seg, long index, MemoryAddress x) {
        MlirDialectRegistry.ptr$VH.set(seg.asSlice(index*sizeof()), x);
    }

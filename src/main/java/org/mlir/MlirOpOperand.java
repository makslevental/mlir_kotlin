...
public class MlirOpOperand {

    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        Constants$root.C_POINTER$LAYOUT.withName("ptr")
    ).withName("MlirOpOperand");
    public static MemoryLayout $LAYOUT() {
        return MlirOpOperand.$struct$LAYOUT;
    }
    ...
    public static VarHandle ptr$VH() {
        return MlirOpOperand.ptr$VH;
    }
    public static MemoryAddress ptr$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)MlirOpOperand.ptr$VH.get(seg);
    }
    public static void ptr$set( MemorySegment seg, MemoryAddress x) {
        MlirOpOperand.ptr$VH.set(seg, x);
    }
    public static MemoryAddress ptr$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)MlirOpOperand.ptr$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void ptr$set(MemorySegment seg, long index, MemoryAddress x) {
        MlirOpOperand.ptr$VH.set(seg.asSlice(index*sizeof()), x);
    }

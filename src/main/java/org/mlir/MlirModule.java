...
public class MlirModule {
    ...
    public static MemoryLayout $LAYOUT() {
        return MlirModule.$struct$LAYOUT;
    }
    ...
    public static VarHandle ptr$VH() {
        return MlirModule.ptr$VH;
    }
    public static MemoryAddress ptr$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)MlirModule.ptr$VH.get(seg);
    }
    public static void ptr$set( MemorySegment seg, MemoryAddress x) {
        MlirModule.ptr$VH.set(seg, x);
    }
    public static MemoryAddress ptr$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)MlirModule.ptr$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void ptr$set(MemorySegment seg, long index, MemoryAddress x) {
        MlirModule.ptr$VH.set(seg.asSlice(index*sizeof()), x);
    }

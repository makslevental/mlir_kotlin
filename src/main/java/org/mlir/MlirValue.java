...
public class MlirValue {

    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        Constants$root.C_POINTER$LAYOUT.withName("ptr")
    ).withName("MlirValue");
    public static MemoryLayout $LAYOUT() {
        return MlirValue.$struct$LAYOUT;
    }
